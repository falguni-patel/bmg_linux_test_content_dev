...
os.makedirs(os.path.dirname(HEAVEN_LOG_FILEPATH), exist_ok=True)
...
# Run the Unigine Heaven script
print("Running Unigine Heaven benchmark...")

heaven_command = f"export DISPLAY=:0 && cd {HEAVEN_DIR} && source {VENV_ACTIVATE} && python3 {HEAVEN_EXECUTION_SCRIPT} {execution_time}"
heaven_process = subprocess.Popen(heaven_command, shell=True, executable="/bin/bash")
