...
os.system(KILL_HEAVEN_CMD)
process = subprocess.Popen([UNIGINE_PATH])
...
run_button_location = pyautogui.locateCenterOnScreen(HEAVEN_RUN_BUTTON_PATH, confidence=0.7, grayscale=True)
...
os.system(KILL_HEAVEN_CMD)
print("Unigine Heaven benchmark closed.")